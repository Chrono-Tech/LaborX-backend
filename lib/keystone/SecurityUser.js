...
SecurityUser.add('Residence', {
  ...
  worker: {
    ...
    isRequested: { type: Boolean, label: 'Is Requested', noedit: true }
  },
  recruiter: {
...
SecurityUser.relationship({ path: 'agents', ref: 'SecurityAgent', refPath: 'user' })

SecurityUser.schema.virtual('agents', {
  ref: 'SecurityAgent',
  localField: '_id',
  foreignField: 'user',
  justOne: false
