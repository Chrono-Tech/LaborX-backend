...
SecurityUser.relationship({ path: 'worker', ref: 'WorkerProfile', refPath: 'user' })

SecurityUser.schema.virtual('worker', {
  ref: 'WorkerProfile',
  localField: '_id',
  foreignField: 'user',
  justOne: true
...
SecurityUser.relationship({ path: 'reqruiter', ref: 'ReqruiterProfile', refPath: 'user' })

SecurityUser.schema.virtual('reqruiter', {
  ref: 'ReqruiterProfile',
  localField: '_id',
  foreignField: 'user',
  justOne: true
})
...
SecurityUser.relationship({ path: 'reqruiterRequests', ref: 'VerificationReqruiterRequest', refPath: 'user' })

SecurityUser.schema.virtual('reqruiterRequests', {
  ref: 'VerificationReqruiterRequest',
  localField: '_id',
  foreignField: 'user',
  justOne: false
})
